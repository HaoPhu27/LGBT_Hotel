...
<section id="rooms" class="bg-gray-100 py-16">
  <div class="max-w-screen-xl mx-auto px-4">
    <h2 class="text-3xl font-bold text-center text-gray-800 mb-12">Danh sách các loại phòng đề xuất</h2>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition cursor-pointer">
        <div class="bg-gray-900 text-white h-48 flex items-center justify-center text-lg">🏰 Presidential Cliff Villa</div>
        <div class="p-6">
  ...
  <div id="room-modal" class="fixed inset-0 flex items-center justify-center z-50 hidden">
    <div class="bg-white max-w-2xl w-full rounded-lg shadow-lg p-6 relative">
      ...
      <div class="text-center">
        <a id="book-now-link" href="#" class="bg-blue-600 text-white px-6 py-2 rounded-full hover:bg-blue-700 transition">Tìm & Đặt phòng</a>
      </div>
    </div>
  </div>
  ...
  <script>
    ...
    document.querySelectorAll("button[data-room]").forEach(btn => {
      btn.addEventListener("click", () => {
        ...
        document.getElementById("modal-content").innerHTML = roomDetails[key] || "Đang cập nhật...";
